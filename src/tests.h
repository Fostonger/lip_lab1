...
result test_multipaged_table_data_adding(database *db);
result test_multipaged_table_data_saving(database *db);
result test_multipaged_table_data_reading(database *db);
